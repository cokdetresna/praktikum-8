...
?>
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Edit Data Peminjaman Buku</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Data Peminjaman Buku</h3>
            </div>
            <!-- /.box-header -->
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="namaPeminjam" placeholder="Masukkan nama anggota">
                </div>
                <div class="form-group">
